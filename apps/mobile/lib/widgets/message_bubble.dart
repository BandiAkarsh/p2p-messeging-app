  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      alignment: isMe
          ...
          : Alignment.centerLeft, // Right if sent by me
      child: Container(
        // Message container
        ...
        decoration: BoxDecoration(
          ...
          color: isMe // Background color
              ...
              : theme
                  .colorScheme.surfaceContainerHighest, // Surface if received
                  ...
                  style: TextStyle(
                    ...
                    color: isMe // Text color
                        ? theme.colorScheme.onPrimary
                            .withValues(alpha: 0.7) // Light if sent
                        : theme.colorScheme.onSurface
                            .withValues(alpha: 0.7), // Dark if received
                  ),
                ),
              ),
            Text(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: isMe // Color
                        ? theme.colorScheme.onPrimary
                            .withValues(alpha: 0.6) // Light
                        : theme.colorScheme.onSurface
                            .withValues(alpha: 0.6), // Dark
                  ),
                ),
