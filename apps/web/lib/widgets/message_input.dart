...
class MessageInput extends StatelessWidget { // Message input widget
  ...
  const MessageInput({ // Constructor
    super.key, // Key
      ...
      child: SafeArea( // Safe area
        child: Row( // Horizontal layout
          children: [                                                 // Children
            ...
            Expanded(                                                 // Flexible text field
              child: TextField( // Text input
                ...
                decoration: InputDecoration( // Input decoration
                  ...
                  fillColor: theme.colorScheme.surfaceContainerHighest, // Fill color
                  border: OutlineInputBorder( // Border style
                    borderRadius: BorderRadius.circular(24),          // Rounded corners
                    borderSide: BorderSide.none,                      // No border
                  ),
                  contentPadding: const EdgeInsets.symmetric(        // Inner padding
